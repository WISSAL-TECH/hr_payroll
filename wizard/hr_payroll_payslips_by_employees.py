# -*- coding: utf-8 -*-
"""functionality for generating payslips for selected employees. It defines a wizard model"""
from odoo import fields, models, _
from odoo.exceptions import UserError


class HrPayslipEmployees(models.TransientModel):
    """This wizard model allows users to generate payslips for the selected employees"""
    ...
    def compute_sheet(self):
        """Generate and compute payslips for selected employees"""
