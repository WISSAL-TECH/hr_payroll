...
class HrContract(models.Model):
    ...
    medical_allowance = fields.Monetary(string="Allocation médicale", help="Medical allowance")
    other_allowance = fields.Monetary(string="Autre allocation", help="Other allowances")
